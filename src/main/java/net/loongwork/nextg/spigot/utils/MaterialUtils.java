...
/**
 * @link https://github.com/EssentialsX/Essentials/blob/2.x/Essentials/src/main/java/com/earth2me/essentials/utils/MaterialUtil.java
 */
public class MaterialUtils {
    public static final Material SPAWNER = EnumUtils.getMaterial("MOB_SPAWNER", "SPAWNER");
    ...
    static {
        HELMETS = EnumUtils.getAllMatching(Material.class, "LEATHER_HELMET", "CHAINMAIL_HELMET", "IRON_HELMET",
                "GOLD_HELMET", "GOLDEN_HELMET", "DIAMOND_HELMET", "NETHERITE_HELMET", "TURTLE_HELMET");

        CHESTPLATES = EnumUtils.getAllMatching(Material.class, "LEATHER_CHESTPLATE", "CHAINMAIL_CHESTPLATE",
                "IRON_CHESTPLATE", "GOLD_CHESTPLATE", "GOLDEN_CHESTPLATE", "DIAMOND_CHESTPLATE", "NETHERITE_CHESTPLATE",
                "ELYTRA");

        LEGGINGS = EnumUtils.getAllMatching(Material.class, "LEATHER_LEGGINGS", "CHAINMAIL_LEGGINGS",
                "IRON_LEGGINGS", "GOLD_LEGGINGS", "GOLDEN_LEGGINGS", "DIAMOND_LEGGINGS", "NETHERITE_LEGGINGS");

        BOOTS = EnumUtils.getAllMatching(Material.class, "LEATHER_BOOTS", "CHAINMAIL_BOOTS", "IRON_BOOTS",
                "GOLD_BOOTS", "GOLDEN_BOOTS", "DIAMOND_BOOTS", "NETHERITE_BOOTS");

        BEDS = EnumUtils.getAllMatching(Material.class, "BED", "BED_BLOCK", "WHITE_BED", "ORANGE_BED",
        ...
        BANNERS = EnumUtils.getAllMatching(Material.class, "BANNER", "WHITE_BANNER",
        ...
        EDITABLE_BOOKS = EnumUtils.getAllMatching(Material.class, "WRITTEN_BOOK", "WRITABLE_BOOK", "BOOK_AND_QUILL");

        FIREWORKS = EnumUtils.getAllMatching(Material.class, "FIREWORK", "FIREWORK_ROCKET");

        FIREWORK_CHARGE = EnumUtils.getAllMatching(Material.class, "FIREWORK_CHARGE", "FIREWORK_STAR");

        LEATHER_ARMOR = EnumUtils.getAllMatching(Material.class, "LEATHER_HELMET",
                "LEATHER_CHESTPLATE", "LEATHER_LEGGINGS", "LEATHER_BOOTS");

        LEGACY_SKULLS = EnumUtils.getAllMatching(Material.class, "SKULL", "SKULL_ITEM");

        MOB_HEADS = EnumUtils.getAllMatching(Material.class, "SKELETON_SKULL",
        ...
        PLAYER_HEADS = EnumUtils.getAllMatching(Material.class, "PLAYER_HEAD", "PLAYER_WALL_HEAD");

        POTIONS = EnumUtils.getAllMatching(Material.class, "POTION", "SPLASH_POTION",
                "LINGERING_POTION", "TIPPED_ARROW");

        SIGN_POSTS = EnumUtils.getAllMatching(Material.class, "SIGN", "SIGN_POST",
                "ACACIA_SIGN", "BIRCH_SIGN",
                "DARK_OAK_SIGN", "JUNGLE_SIGN",
                "OAK_SIGN", "SPRUCE_SIGN",
                "CRIMSON_SIGN", "WARPED_SIGN");

        WALL_SIGNS = EnumUtils.getAllMatching(Material.class, "WALL_SIGN",
    ...
    public static boolean isPlayerHead(final ItemStack stack) {
        return PLAYER_HEADS.contains(stack.getType());
    }
    ...
    public static void setDamage(final ItemStack stack, final int damage) {
        if (stack.getItemMeta() instanceof final Damageable damageable) {
